...
export class QuestionPostMailTemplate {
  ...
  public getQuestionPostMailTemplate(question: any, askedByUser: string): string {
    const content = `
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        ...
                                                                                                        <p>This question is just asked by <strong>${askedByUser}</strong> on ${moment(question.createdOn).format('LLLL')}.He is waiting for approval of this question, so please have a look and approve and mark it published.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                    <tr>
                                                        <td style='border-bottom-left-radius:3px;border-bottom-right-radius:3px;' align='left'>
                                                            <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                                                                <div class="contentEditable" >
                                                                    <h4 style="color: #007db8; font-family: inherit;"><a href="https://www.tecknocracy.com/question/${question._id}?q=preview" style="text-decoration: none;color: currentColor;">${question.title}</a></h4>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td valign="top" class="specbundle2"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                            ...
                                                            <tr>
                                                                <td align='left' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p>${this.utilService.decodeHTML(question.content)}</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align='right' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable" >
                                                                            <a target='_blank' href="http://www.tecknocracy.com/question/${question._id}?q=preview" class='link1'>Review it →</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
