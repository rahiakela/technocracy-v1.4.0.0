...
export class QuestionPublishMailTemplate {
  ...
  public getQuestionPublishMailTemplate(question: any, recipient: any, user: any, askedByUser: string): string {
    let content = `
    ...
    if (user._id.toString() === question.askedBy._id.toString()) {
      content += `
                                                                                                        <br/>
                                                                                                        <p>Hey <strong>${this.utilService.getUserName(user)}</strong>,</p>
