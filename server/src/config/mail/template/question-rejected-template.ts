...
export class QuestionRejectedMailTemplate {
    ...
    public getQuestionRejectedMailTemplate(question: any, recipient: any, askedByUser: string): string {
        const content = `
                                                                ...
                                                                <tr>
                                                                    <td align='left' valign='top'>
                                                                        <div class="contentEditableContainer contentTextEditable">
                                                                            <div class="contentEditable">
                                                                                <p >
                                                                                    ${question.content.length > 299 ? this.utilService.decodeHTML(question.content.substring(0, 300)) : this.utilService.decodeHTML(question.content)}
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
