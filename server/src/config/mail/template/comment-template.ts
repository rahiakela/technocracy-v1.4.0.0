...
export class CommentMailTemplate {
  ...
  public getCommentMailTemplate(mailOptions: Map<string, any>, recipient: string, notifyType: string): string {
    const blogId = notifyType === 'blog' ? mailOptions.get('blog')._id : mailOptions.get('question')._id;
    const title = notifyType === 'blog' ? mailOptions.get('blog').title : mailOptions.get('question').title;
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p><strong>${this.utilService.getUserName(mailOptions.get('user'))}</strong> commented on <strong><a href="https://www.tecknocracy.com/#/${notifyType}/${blogId}" style="color:#007db8;">${title}</a></strong> ${notifyType}:</p><br/>
                                                                                                        `;
    if (mailOptions.get('reply')) {
      content += `
                                                                                                        <p>in response to <strong>${this.utilService.getUserName(mailOptions.get('comment').commentedBy)}</strong>:</p>
                                                                                                        <blockquote style="font-family: Times, serif;font-size: 1.1em;font-style: italic;color: #878787;border-left: 3px solid #ccc;margin: 1em 1em 1em 2em;padding-left: 1em;">
                                                                                                            <p style="color: #007db8;font-weight: bold;">${this.utilService.decodeHTML(mailOptions.get('comment').content)}</p>
                                                                                                        </blockquote>
        `;
    }
    if (mailOptions.get('reply')) {
      content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${this.utilService.decodeHTML(mailOptions.get('reply').content)}</p>
        `;
    } else {
      content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${this.utilService.decodeHTML(
    ...
    content += `
                                                                            ...
                                                                            <tr>
                                                                                <td align='right' valign='top'>
                                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                                        <div class="contentEditable" >
                                                                                            <a target='_blank' href="http://www.tecknocracy.com/#/${notifyType}/${blogId}" class='link1'>Reply →</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
